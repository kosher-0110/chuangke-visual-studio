  ...
  return (
    <main className="min-h-screen bg-ink px-4 py-5 text-bone md:px-5 md:py-8">
      ...
      <section className="mx-auto max-w-7xl py-12 md:py-24">
        <div className="mb-10 border-y border-line py-8 md:mb-16 md:py-14">
          <div className="grid gap-8 md:grid-cols-[1.05fr_0.95fr] md:items-end">
            <div>
              <p className="mb-4 text-xs uppercase tracking-studio text-bone/42 md:mb-5">品牌全案 / BRAND DECKS</p>
              <h1 className="font-display text-[clamp(3rem,17vw,5.5rem)] leading-[0.95] text-bone md:text-[clamp(3.6rem,8vw,8.8rem)] md:leading-[0.9]">
                品牌提案归档
              </h1>
            ...
            <div className="max-w-xl md:justify-self-end">
              <p className="text-lg leading-8 text-bone/78 md:text-2xl md:leading-10">
